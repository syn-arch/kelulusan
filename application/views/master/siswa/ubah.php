					...
					<div class="row">
						<div class="col-md-8 offset-md-2">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control <?php if(form_error('nisn')) echo 'is-invalid'?>" name="nisn" id="nisn" placeholder="NISN" value="<?php echo $siswa['nisn'] ?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control <?php if(form_error('no_peserta_ujian')) echo 'is-invalid'?>" name="no_peserta_ujian" id="no_peserta_ujian" placeholder="No Peserta Ujian" value="<?php echo $siswa['no_peserta_ujian'] ?>">
