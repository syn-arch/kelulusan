			...
			<div class="card-body">
				...
				<div class="col-md-8 offset-md-2">
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<select name="id_siswa" id="id_siswa" class="form-control id_siswa <?php if(form_error('id_siswa')) echo 'is-invalid'?>">
								...
								<?php foreach ($siswa as $row): ?>
									<option value="<?php echo $row['id_siswa'] ?>" <?php echo $row['id_siswa'] == $berkas['id_siswa'] ? 'selected' : '' ?>><?php echo $row['nama_siswa'] ?></option>
								<?php endforeach ?>
							</select>
						...
						<img src="<?php echo base_url('assets/img/berkas/') . $berkas['berkas'] ?>" alt="Berkas" class="img-fluid">
						<div class="form-group">
							<label for="keterangan">Keterangan</label>
							<textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control textarea <?php if(form_error('keterangan')) echo 'is-invalid'?>" placeholder="keterangan"><?php echo $berkas['keterangan'] ?></textarea>
